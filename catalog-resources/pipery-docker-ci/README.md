# Pipery Docker CI Component

Reusable GitLab CI/CD component for complete Docker CI pipeline with structured logging.

## Overview

This component provides a complete CI/CD pipeline for Docker projects:
- SAST scanning
...
```yaml
include:
  - component: $CI_SERVER_FQDN/pipery-dev/pipery-docker-ci/catalog-resources/pipery-docker-ci@main
...
| DOCKER_VERSION | latest | Docker runtime version |
